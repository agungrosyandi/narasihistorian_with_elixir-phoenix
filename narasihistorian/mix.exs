defmodule Narasihistorian.MixProject do
  use Mix.Project
  ...
  def application do
    [
      mod: {Narasihistorian.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind narasihistorian", "esbuild narasihistorian"],
      "assets.deploy": [
        "tailwind narasihistorian --minify",
        "esbuild narasihistorian --minify",
        "phx.digest"
      ],
