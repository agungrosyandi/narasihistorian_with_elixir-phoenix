defmodule NarasihistorianWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: NarasihistorianWeb.Gettext
  ...
  """
  attr :rest, :global, doc: "the arbitrary HTML attributes to add to the header"
  slot :inner_block, required: true
  slot :subtitle
  slot :actions
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NarasihistorianWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NarasihistorianWeb.Gettext, "errors", msg, opts)
    end
  end
