...
config :narasihistorian, NarasihistorianWeb.Endpoint,
  ...
  secret_key_base: "YzqeTHOjyuzxMlvM8QZ4vJdGhxKzB+Mzjo3BoRxWOuf8lrMXe/brUkDqYK4cdh4b",
  server: false

# In test we don't send emails
config :narasihistorian, Narasihistorian.Mailer, adapter: Swoosh.Adapters.Test
