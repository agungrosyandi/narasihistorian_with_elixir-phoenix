defmodule NarasihistorianWeb.CategoryLiveTest do
  use NarasihistorianWeb.ConnCase

  import Phoenix.LiveViewTest
  import Narasihistorian.CategoriesFixtures

  @create_attrs %{category_name: "some category_name", slug: "some slug"}
  @update_attrs %{category_name: "some updated category_name", slug: "some updated slug"}
  @invalid_attrs %{category_name: nil, slug: nil}
